                    ...
                    <div class="card-body col-md-12">
                        <div class="row">
                            ...
                            <div class="row col-md-6">
                                <div class="col-3">
                                    @foreach ($listTransaksi as $transaksiData)
                                        <input type="hidden" class="transaksi_id" value="{{$transaksiData->transaksi_id}}">
                                    @endforeach
                                    ...
                                    <div class="form-group" id='formPaket'>
                                        ...
                                        <div style="margin: 0px; padding: 0px;">
                                            <select id="paketInput0" class="paket" data-input="paket" data-hitung="0"
                                ...
                                <div class="col-3">
                                    ...
                                    <div style="margin-top: 65px;" class="form-group addOrder0">
                                        ...
                                        <button type="button" class="login100-form-btn" name="add" id="hapusRow"
