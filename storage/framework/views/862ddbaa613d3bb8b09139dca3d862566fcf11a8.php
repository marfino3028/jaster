...
<div class="section-body">
    ...
    <form method="post" action="<?php echo e(route('updateCampaign', ['id' => request()->route('id')])); ?>" class="needs-validation" novalidate="">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" class="form-control" name="nama" value="<?php echo e($edit->nama_customer); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="akun_adwords" required>
                                ...
                                <option value="<?php echo e($list->adsakun_id); ?>" <?php if($list->adsakun_id == $edit->adsakun_id): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($list->nama_akun); ?></option>
                        ...
                        <div class="form-group">
                            <label>Saldo</label>
                            <input type="text" class="form-control" name="saldo" value="<?php echo e($edit->saldo_adwords); ?>">
                            <div class="invalid-feedback">
                                Input Saldo bosz!
                            </div>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo e($edit->tanggal_mulai); ?>" class="form-control datepicker" placeholder="YYYY-MM-DD" name="tanggal_mulai"
                                required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo e($edit->tanggal_akhir); ?>" class="form-control datepicker" placeholder="YYYY-MM-DD" name="tanggal_akhir"
                                required>
                            <div class="invalid-feedback">
                                Input tanggal dengan benar
                            </div>
                        ...
                        <div class="form-group">
                            <label>Catatan</label>
                            <textarea name="catatan" id="notes"><?php echo e($edit->notes); ?></textarea>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6762345/public_html/public/resources/views/backend/pages/edit-campaign.blade.php ENDPATH**/ ?>