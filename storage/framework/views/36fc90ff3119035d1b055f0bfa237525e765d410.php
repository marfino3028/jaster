...
<div class="section-body">
    ...
    <form method="post" action="<?php echo e(route('storeTransfer')); ?>" class="needs-validation" novalidate="">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <?php echo csrf_field(); ?>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="nama_campaign" required>
                                ...
                                <option value="<?php echo e($list->adscampaign_id); ?>"><?php echo e($list->nama_customer); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6762345/public_html/public/resources/views/backend/pages/add-transfer.blade.php ENDPATH**/ ?>