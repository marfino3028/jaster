...
<!-- <script>
    $('#nilaiDisable').change(function () {
        if ($('#default').is(':selected') == true) {
            $('#nilaiDisable').prop('disabled', true);
        } else {
            $('#nilaiDisable').prop('disabled', false);
        }
    })
</script> -->
<!-- <script>
    $('[name="parent_id"]').change(function () {
        var nilai = $('[name="nilai"]');

        var nilaiEnabled = $(this).val() === "Setup";
        nilai.prop("disabled", !nilaiEnabled)
    }).change()
</script> -->
<?php $__env->stopSection(); ?>

<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jasterman\resources\views/backend/pages/add-category.blade.php ENDPATH**/ ?>