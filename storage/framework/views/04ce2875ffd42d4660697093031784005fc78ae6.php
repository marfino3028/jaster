                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="nilai" id="nilai" disabled>
                                    <option value="" <?php if($edit->nilai == ''): ?> <?php echo e('selected'); ?> <?php else: ?> <?php echo e(''); ?> <?php endif; ?>>None</option>
                                    <option value="10" <?php if($edit->nilai == 10): ?> <?php echo e('selected'); ?> <?php else: ?> <?php echo e(''); ?> <?php endif; ?>>10</option>
                                    <option value="15" <?php if($edit->nilai == 15): ?> <?php echo e('selected'); ?> <?php else: ?> <?php echo e(''); ?> <?php endif; ?>>15</option>
                                    <option value="18" <?php if($edit->nilai == 18): ?> <?php echo e('selected'); ?> <?php else: ?> <?php echo e(''); ?> <?php endif; ?>>18</option>
                                    <option value="21" <?php if($edit->nilai == 21): ?> <?php echo e('selected'); ?> <?php else: ?> <?php echo e(''); ?> <?php endif; ?>>21</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-6">
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6762345/public_html/public/resources/views/backend/pages/edit-category.blade.php ENDPATH**/ ?>