            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" placeholder="YYYY-MM-DD" name="duedate"
                                required value=<?php echo e($edit->duedate); ?>>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <label>Request</label>
                            <textarea class="form-control summernote-simple" name="request"><?php echo e($edit->request); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Web Pesaing</label>
                            <textarea class="form-control summernote-simple" name="web_pesaing"><?php echo e($edit->web_pesaing); ?></textarea>
                        </div>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6762345/public_html/public/resources/views/backend/pages/edit-order.blade.php ENDPATH**/ ?>